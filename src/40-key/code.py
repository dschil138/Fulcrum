...
keyboard.keymap = (
    ...
    [
                        ...
                        KC.BSPC, KC.A,  KC.R,  KC.S,  KC.T,  KC.Q,         KC.M,  KC.N,  KC.E,  KC.I,  KC.O,     KC.ENT,\
                        KC.LSFT, KC.Z,  KC.X,  KC.C,  KC.D,  KC.V,         KC.K,  KC.H,  KC.COMMA, KC.DOT, KC.SLASH, KC.RSFT,\
        KC.LALT,  undo,  KC.LGUI,  redo,     SPC_sft,  ESC_gui_sft,        FIND_gui,  KC.MO(1),     KC.MO(2),  KC.LEADER,  KC.TAB,  KC.RCTL,\
    ...
    # [2] NUM
    [
            KC.BSPC, KC.NO, KC.NO,     KC.UP,     KC.NO,     KC.NO,           KC.NO, KC.N7,  KC.N8,   KC.N9,   KC.N0, KC.BSPC, \
            KC.BSPC, KC.NO, KC.RIGHT,  KC.DOWN,   KC.LEFT,   KC.NO,           KC.NO, KC.N4,  KC.N5,   KC.N6,   KC.N7, KC.BSPC, \
            KC.BSPC, KC.NO, KC.NO,     KC.NO,     KC.NO,     KC.NO,           KC.NO, KC.N1,  KC.N2,   KC.N3,   KC.NO, KC.BSPC, \
